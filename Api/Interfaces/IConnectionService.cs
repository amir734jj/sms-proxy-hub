...
public interface IConnectionService
{
    ...
    Task<WebhookRevalidationResult?> RevalidateWebhookAsync(Guid userId, Guid id);
    Task<List<RegisteredWebhookDto>?> GetRegisteredWebhooksAsync(Guid userId, Guid id);
